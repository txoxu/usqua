...
=end
  ...
  cocktails = [
    ...
    {id: 12, cocktail_name: "スコッチ・コリンズ", cocktail_create: "シェイクして、氷を入れたグラスに炭酸水を注ぐ", cocktail_origin: "１９世紀のロンドンで、リマーズクラブのヘッドウエイターであったジョン・コリンズに由来する", cocktail_recipe: "スコッチウイスキー: 60ml, レモンジュース: 20ml, 砂糖: 2ティースプーン, 炭酸水: 適量", cocktail_url: "https://www.youtube.com/watch?v=Z6nsGVnbj5g?si=wkOH1KTh0aZacRm3"},
    {id: 13, cocktail_name: "ラスティ・ネイル", cocktail_create: "氷を入れたグラスに注ぎ、ステアする", cocktail_origin: "ラスティ・ネイルとは「錆びた釘」という意味", cocktail_recipe: "スコッチウイスキー: 30ml, ドランブイ: 30ml", cocktail_url: "https://www.youtube.com/watch?v=5YnaJxkbTns?si=cEZHVliQWmIn_8D9"},
    {id: 14, cocktail_name: '', cocktail_create: '', cocktail_origin: '', cocktail_recipe: '', cocktail_url: ''},
    {id: 15, cocktail_name: '', cocktail_create: '', cocktail_origin: '', cocktail_recipe: '', cocktail_url: ''},
    {id: 16, cocktail_name: '', cocktail_create: '', cocktail_origin: '', cocktail_recipe: '', cocktail_url: ''},
    {id: 17, cocktail_name: '', cocktail_create: '', cocktail_origin: '', cocktail_recipe: '', cocktail_url: ''},
