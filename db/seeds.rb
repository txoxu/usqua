...
#      cocktail_name: 'ロブ・ロイ',
#      cocktail_origin: '実在した義賊ロバート・マクレガーの愛称とされている',
...
#      cocktail_origin: 'キルトとは、スコットランドのタータン・チェックのプリーツスカート風民族衣装のことで
#                       そこから由来されたとされている',
...
#      cocktail_origin: '名前の由来は明確に伝わっていない。一般的には、アメリカのカリフォルニア州の温暖な気候や、
#                       レモンジュースを使用したレモネードを連想させることから名付けられたと考えられています。',
...
#      cocktail_origin: 'アメリカのバーボンウイスキーと牛乳の組み合わせが、
#                       アメリカの象徴的な存在である「カウボーイ」と結びついたことに由来すると考えられています。',
...
#      cocktail_name: 'ハンター',
#      cocktail_origin: '英語で「狩人」を意味する「ハンター」ですが、ここでは「都会の夜を狩る」という意味が込められています。
#                       深みのある赤色と妖しい雰囲気が、夜の都会的な魅力を象徴している',
#      cocktail_recipe: 'ライウイスキー: 3/4, チェリーブランデー: 1/4',
#      cocktail_url: 'OTWVeMwQNzs?si=sLAQwaO8ge92zqrR',
#      cocktail_image: 'ハンター.webp' },
#    { id: 17, base_cocktail_id: 3,
#      cocktail_name: 'インク・ストリート',
#      cocktail_origin: 'ロンドンの「フリート・ストリート」に関連しています。',
...
#      cocktail_origin: '19世紀後半にニューヨークのバーテンダーが考案し,
#                       当時のバーテンダーたちが好んで作っていたことから、「オールドファッション」と呼ばれるようになりました。',
...
#      cocktail_origin: '1920年代にパリの「ハリーズ・ニューヨーク・バー」
#                       の常連客であったスパロー・ロビンソン氏が考案したとされています。',
...
#      cocktail_name: 'ブラックソーン', cocktail_origin: 'スローベリー（スピノサスモモ）の英名「ブラックソーン」に由来します',
...
#      cocktail_origin: '1922年に公開された映画『Blood and Sand（邦題：血と砂）』に由来しています。',
...
#      cocktail_origin: '1972年に公開された映画『ゴッドファーザー』に由来しています。映画の公開直後に考案され、
#                       作品内で描かれるイタリア系アメリカ人社会にちなみ、イタリアのリキュールであるアマレットが使用されています',
...
#      cocktail_origin: 'ゴルフの「ホールインワン」に由来しています',
...
#      cocktail_name: 'ハリケーン',
#      cocktail_origin: 'カクテルが提供される際に使用されるハリケーンランプに似た独特の形状のグラスに由来しています。',
...
#      cocktail_origin: '「インペリアル」は「皇帝」や「帝国」を意味します。
#                       高貴なイメージを持つことから、この名前が付けられたと考えられます。 ',
...
#      cocktail_origin: 'ロンドンのボーイ長、ジョン・コリンズの名前に由来しています。',
...
#      cocktail_origin: '19世紀末のゴールドラッシュで有名なカナダのユーコン準州にある「クロンダイク」地域に由来しています。',
...
#      cocktail_origin: 'ミントの清涼感と「クーラー」というスタイルに由来しています。
#                       「クーラー」は、スピリッツやワインに柑橘系のジュースを加え、
#                       炭酸飲料で割ったカクテルの総称で、涼やかな味わいを意図したものです。 ',
