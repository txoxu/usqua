...
ActiveRecord::Schema[7.1].define(version: 20_240_923_172_937) do
  ...
  create_table 'bookmarks', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id cocktail_id], name: 'index_bookmarks_on_user_id_and_cocktail_id', unique: true
  ...
  create_table 'user_cocktail_badges', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id cocktail_badge_id], name: 'index_user_cocktail_badges_on_user_id_and_cocktail_badge_id',
                                           unique: true
  ...
  create_table 'user_whiskey_badges', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id whiskey_badge_id], name: 'index_user_whiskey_badges_on_user_id_and_whiskey_badge_id',
                                          unique: true
